...
(function () {
    ...
    Asyst.protocol.thinDataIfNotPacket = Asyst.protocol.thinDataIfNotPacket
        || function (data, isAggressive) {
            ...
            if (data["__packet__"]) return data;

            if (!Asyst.protocol.thiningData)
                throw {
                    error: 'Function "Asyst.protocol.thiningData" need to be defined'
                };
    ...
    {//region Asyst.API
        ...
        if (!Asyst.APIv2.Entity.save) {
            Asyst.APIv2.Entity.save = function (params) {
                ...
                return Asyst.protocol.send("/asyst/entity/" + params.entityName + "/" + params.dataId, "POST", thinnedData, params.async, params.success, params.error, null, params.headers);
            };
        }
        ...
        if (!Asyst.APIv2.Form.load) {
            Asyst.APIv2.Form.load = function (params) {
                ...
                var data = params.defaults || null;
                //If we have additional parameters, send them in a request body (PUT method)
                var httpRequestMethod = data === null ? "GET" : "PUT";
                var error = params.error;
                return Asyst.protocol.send("/asyst/form/" + params.formName + "/" + params.dataId, httpRequestMethod, data, params.async, success, error, null, params.headers);
            };
        }
        ...
        if (!Asyst.APIv2.Form.handlerAction) {
            Asyst.APIv2.Form.handlerAction = function (params) {
                var thinnedData = Asyst.protocol.thinDataIfNotPacket(params.data);
                params = $.extend({ async: true }, params);
                return Asyst.protocol.send("/asyst/form/" + params.formName + "/" + params.handlerName + "/" + params.actionId + "/" + params.checked, "POST", thinnedData, params.async, params.success, params.error);
            };
        }
        ...
        if (!Asyst.APIv2.Form.handlerCheckRule) {
            Asyst.APIv2.Form.handlerCheckRule = function (params) {
                var thinnedData = Asyst.protocol.thinDataIfNotPacket(params.data);
                params = $.extend({ async: true }, params);
                return Asyst.protocol.send("/asyst/rule/FormsRules/" + params.ruleName, "POST", thinnedData, params.async, params.success, params.error, null, params.headers);
            };
        }
        ...
        if (!Asyst.APIv2.Form.save) {
            Asyst.APIv2.Form.save = function (params) {
                ...
                return Asyst.protocol.send("/asyst/form/" + params.formName + "/" + params.dataId, "POST", thinnedData, params.async, params.success, params.error, null, params.headers);
            };
        }
        ...
        if (!Asyst.APIv2.View.load) {
            Asyst.APIv2.View.load = function (params) {
                var thinnedData = Asyst.protocol.thinDataIfNotPacket(params.data);
                params = $.extend({ async: true }, params);
                return Asyst.protocol.send("/asyst/view/" + params.viewName, "POST", thinnedData, params.async, params.success, params.error, null, params.headers);
            };
        }
        ...
        if (!Asyst.APIv2.DataSet.load) {
            Asyst.APIv2.DataSet.load = function (params) {
                ...
                return Asyst.protocol.send('/asyst/api/dataset/' + params.name, "POST", thinnedData, params.async, success, params.error);
            };
        }
        ...
        if (!Asyst.APIv2.Document.getFiles) {
            Asyst.APIv2.Document.getFiles = function (params) {
                ...
                params = $.extend({ async: true }, params);
                return Asyst.protocol.send("/asyst/api/file/getFilesInfo/", "POST", thinnedData, params.async, params.success, params.error, null, params.headers);
            };
        }
        ...
        if (!Asyst.APIv2.Document.deleteFile) {
            Asyst.APIv2.Document.deleteFile = function (params) {
                params = $.extend({ async: true }, params);
                return Asyst.protocol.send("/asyst/api/file/delete/", "POST", params.data, params.async, params.success, params.error, null, params.headers);
            };
        }

        if (!Asyst.APIv2.Document.attachToCard) {
            Asyst.APIv2.Document.attachToCard = function (params) {
                var thinnedData = Asyst.protocol.thiningData(params.data, false);
                params = $.extend({ async: true }, params);
                return Asyst.protocol.send("/asyst/api/file/attachToCard/", "POST", thinnedData, params.async, params.success, params.error, null, params.headers);
            };
        }
        ...
        if (!Asyst.APIv2.Document.getInfo) {
            Asyst.APIv2.Document.getInfo = function (params) {
                var thinnedData = Asyst.protocol.thiningData(params.data, true);
                params = $.extend({ async: true }, params);
                return Asyst.protocol.send('/asyst/api/file/getFileInfo/', 'POST', thinnedData, params.async, params.success, params.error, null, params.headers);
            };
        }
        ...
        if (!Asyst.APIv2.Document.saveLink) {
            Asyst.APIv2.Document.saveLink = function (params) {
                var thinnedData = Asyst.protocol.thiningData(params.data, true);
                return Asyst.protocol.send('/asyst/api/file/saveLink/', 'POST', thinnedData, params.async, params.success, params.error, null, params.headers);
            };
        }
