...
(function () {
    ...
    function loadAllDataVizualization() {
        ...
        var filter = [
            ...
            { type: 'select', width: '300px', index: 2, multiple: true, dictionary: 'portfolio', id: 'portfolioid', name: 'portfolioname', placeholder: 'Портфель' },
            { type: 'select', width: '300px', index: 3, multiple: true, dictionary: 'project', id: 'projectid', name: 'projectname', placeholder: 'Проект' },
            { type: 'select', width: '210px', index: 4, multiple: true, dictionary: 'status', id: 'statusid', name: 'statusname', placeholder: 'Статус КТ' },
