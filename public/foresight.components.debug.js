                    ...
                    that.render_carousel = function(){
                        ...
                        that.data.items.forEach(function(item){
                            ...
                            if (that.data.type == 'image') {
                                $item = $([
                                    '<div class="carousel__item">',
                                    (item.url ? '<a href="' + item.url + '" class="carousel__item-image link" style="background-image: url(' + encodeURIComponent(item.image) + ')"></a>' : '<span class="carousel__item-image link" style="background-image: url(' + item.image + ')"></span>'),
